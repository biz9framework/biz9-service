...
const error_main = (title,str) => {
    ...
    console.log('ERROR___' +title.toUpperCase()+ '___START__________________');
    console.error(str);
    console.log('ERROR___' +title.toUpperCase()+ '___END_____________________');
}
const w_main = (title,str) => {
    ...
    console.log('PRINT___' +title.toUpperCase()+ '___START__________________');
    console.log(str);
    console.log('PRINT___' +title.toUpperCase()+ '___END_____________________');
}
