...
## Overview
The BiZ9-Service is a REST API service layer that provides business logic for client based applications. Web based platforms, Apple and Android devices utilize the BiZ9-Service to handle work flow, data access, validation, photo handling, and any other server side rendering. 

### Primary features included are:

- BiZ9-Mobile applications primary service.
- Data processing
- Cloud photo management
- Business logic funcntionality
