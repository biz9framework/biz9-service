module.exports = function(){
	async = require('async');
	module.cart_checkout_order_add_old=function(customer,shipping,billing,cart,callback){
		var error=null;
		async.series([
			function(call){
				//- order
	...
	module.set_order_shipping_old=function(item){
	...
	module.set_order_customer_old=function(item){
	...
	module.set_order_billing_old=function(item){
	...
	module.get_product_cart_checkout_confirmation_send_in_blue_old=function(customer,shipping,billing,cart,order,mail,callback){
